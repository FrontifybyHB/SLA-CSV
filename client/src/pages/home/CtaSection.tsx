      ...
      <div className="home-container">
        <div className="max-w-[40rem] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-center gap-3 sm:gap-4 max-w-[28rem] mx-auto mb-4">
            <DashboardLink className="inline-flex items-center justify-center gap-2 min-h-[2.5rem] px-5 py-2.5 bg-sla-primary-container text-sla-on-primary text-headline-sm font-semibold text-nowrap rounded-sm border-none cursor-pointer transition-colors shadow-[0_1px_2px_rgb(16_24_40/0.06)] hover:bg-sla-primary">
